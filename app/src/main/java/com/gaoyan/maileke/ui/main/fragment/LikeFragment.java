...
import com.gaoyan.maileke.presenter.main.LikePresenter;
import com.gaoyan.maileke.base.contract.main.LikeContract;
import com.gaoyan.maileke.ui.main.adapter.LikeAdapter;
    ...
    public void onHiddenChanged(boolean hidden) {
        ...
        if (!hidden) {
            ...
            if (!mPresenter.getLikePoint()) {
                SnackbarUtil.show(rvLikeList,"左右滑动删除，上下滑动排序(。・`ω´・)");
